...
export default function ToolBar(){
    ...
    <div className=" bg-green-500 top-0 sticky z-50  w-full">
        <div className="shadow-lg pt-2  h-fit flex items-center py-[4px]  bg-white px-2 justify-between">
            <div className="flex gap-1 items-center cursor-pointer">
                <p className="text-sm">My open leads</p> <ChevronDown size={18}/>
            </div>
            <div className="flex items-center w-[70%] justify-between">
                <div className="flex items-center gap-1 rounded-sm p-[3px] cursor-pointer hover:bg-[#f6f6f6]">
                    ...
                    <p className="text-sm">Show Chart</p>
                </div>
                <div className="flex items-center gap-1 rounded-sm p-[3px] cursor-pointer hover:bg-[#f6f6f6]">
                    <FormatListBulletedOutlinedIcon sx={{ fontSize: '20px', color: '#3e6dc4'}}/> 
                    <p className="text-sm">Focused view</p>
                </div>
                <div className="flex items-center gap-1 [3px] cursor-pointer hover:bg-[#f6f6f6]">
                    <AddOutlinedIcon sx={{ fontSize: '25px', color: '#32cab1'}}/> 
                    <p className="text-sm">New</p>
                </div>
                <div className="flex items-center [3px] cursor-pointer hover:bg-[#f6f6f6]">
                ...
                <div className="flex items-center group gap-1 [3px] cursor-pointer hover:bg-[#f6f6f6]">
                ...
                <div className="flex items-center hover:bg-[#f6f6f6] cursor-pointer rounded-sm p-[5px] border-[1px] gap-1">
                    ...
                    <p className="text-sm">Smart data</p>
                </div>
                <div className="flex items-center hover:bg-[#f6f6f6] cursor-pointer rounded-sm p-[5px] border-[1px] gap-1">
                    <FilterListOutlinedIcon sx={{fontSize: '20px'}}/> 
                    <p className="text-sm">Edit filters</p>
                </div>
                <div className="flex items-center hover:bg-[#f6f6f6] cursor-pointer rounded-sm p-[5px] border-[1px] gap-1">
