...
const leads = [
  { id: 'd6e15727-9fe1-4961-8c5b-ea44a9bd81aa', name: 'Winford Asher', topic: 'Cafe A 100 commercial use', status: 'new', date: '04/02/2024 12:45 PM' },
  { id: '3958dc9e-712f-4377-85e9-fec4b6a6442a', name: 'Josia Love', topic: 'Upgrading service plan', status: 'in-progress', date: '30/03/2024 1:59 PM' },
  { id: '3958dc9e-742f-4377-85e9-fec4b6a6442a', name: 'Harrison Curtis', topic: 'Issue with throughput on EspressoMaster', status: 'closed', date: '28/03/2024 3:50 PM' },
  { id: '76d65c26-f784-44a2-ac19-586678f7c2f2', name: 'Jermaine Berrett', topic: 'New roaster in distribution facility', status: 'new', date: '25/03/2024 3:28 PM' },
  { id: 'CC27C14A-0ACF-4F4A-A6C9-D45682C144B9', name: 'Gerald Stephens', topic: 'Concern on current machines', status: 'in-progress', date: '23/03/2024 2:30 PM' },
  { id: '13D07535-C59E-4157-A011-F8D2EF4E0CBB', name: 'Haile Griffiths', topic: 'Expanding business', status: 'closed', date: '21/03/2024 5:05 PM' },
  { id: '13D07535-C59E-4157-A011-F8D2EF4E0CBB', name: 'Rachael Michael', topic: 'Addressing service concerns', status: 'new', date: '19/03/2024 9:15 AM' },
  { id: '13D07535-C59E-4157-A011-F8D2EF4E0CBB', name: 'Alex Baker', topic: 'Premium coffee beans', status: 'in-progress', date: '17/03/2024 8:30 AM' },
  { id: '13D07535-C59E-4157-A011-F8D2EF4E0CBB', name: 'Lilly Pyles', topic: 'Cafe A 100 bulk rate', status: 'closed', date: '13/02/2024 4:15 PM' },
  { id: '13D07535-C59E-4157-A011-F8D2EF4E0CBB', name: 'Jane Reyes', topic: 'Improving cost by cup', status: 'new', date: '10/03/2024 11:45 AM' },
  { id: '4832AB23-1A7F-412C-91B3-2A67D9E7B3B9', name: 'Peter White', topic: 'Custom coffee blends for office', status: 'in-progress', date: '03/05/2024 6:15 AM' },
  { id: '5D9B2C14-8FC9-4D4B-939A-C6A76C0E3D1D', name: 'Sophia Lang', topic: 'Scheduling a product demo', status: 'new', date: '27/02/2024 8:15 AM' },
  { id: 'F7E32B6A-C0A1-4692-8DF8-9C676A8E5B3D', name: 'Lucas Brown', topic: 'Inquiry about Espresso Pro XL', status: 'closed', date: '20/02/2024 2:15 AM' },
  { id: '19D83B7A-8CE3-435B-AF72-C9A70E9D5B3F', name: 'Emma Taylor', topic: 'Discussing eco-friendly packaging', status: 'in-progress', date: '02/15/2024 8:15 AM' },
  { id: '9AB47D8A-23F8-4E49-8C19-C8A76D7B3E9D', name: 'Oliver Davis', topic: 'Replacing older machines', status: 'new', date: '10/2024/02 12:30 PM' },
];
